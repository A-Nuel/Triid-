...
import { Loader2, Zap, CheckCircle2, MapPin, Star } from "lucide-react";
...
export function EmergencyMatching() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col justify-center items-center p-6 text-white text-center">
        ...
        <div className="flex flex-col items-center max-w-sm w-full animate-in slide-in-from-bottom-8 duration-500">
          ...
          <div className="bg-white text-gray-900 rounded-2xl p-6 w-full text-left shadow-xl mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="font-bold text-xl">{artisan.users?.full_name}</h3>
